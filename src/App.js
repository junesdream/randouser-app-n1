...
const style = {
	...
	return (
		<div className="App">
			<span className="app-title">Random User Generator App</span>
              ...
              <Fragment key ={user.cell}>
                ...
                <div className="app__icons">
                  {icons.map((icon, index) => {
                    return(
                      <i className={icon} key={index} onMouseEnter={() => activeLinkHandler(index)}  style={activeLink === index ? style : null}></i>
                    )
                  })}
                </div>
              </Fragment>
